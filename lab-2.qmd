...
Going to use the raw counts to make the bar graphs since averaging proportions across countries doesn't make sense, and the weight adjustment they used for the proportions is unclear
